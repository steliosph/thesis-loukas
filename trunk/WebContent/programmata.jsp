		...
		<div class="full-page">
			<div class="portfolio">
                            <div class="portfolio-item">
                                    <h2>Μπορώ!</h2><br>
						<a href="mporw.jsp" ><img src="images/mporo.jpg"></a>
                                                <p>Μπες στον κόσμο της αποταμίευσης με το λογαριασμό ταμιευτηρίου "Μπορώ". Η συστηματική αποταμίευση ποτέ δεν ήταν πιο εύκολη και ταυτόχρονα αποδοτική! Αποταμίευσε αυτόματα!Ενεργοποίησε μία πάγια εντολή και μετέφερε αυτόματα...</p>
				...
				<div class="portfolio-item">
						...
						<a href="epistrofi.jsp"><img src="images/logo epistrofi.jpg"  /></a>
                                                <p>Η Επιστροφή, το μεγαλύτερο πρόγραμμα επιβράβευσης καρτών, επιβραβεύει τις αγορές σας με κάρτες DreamBank σε ένα ευρύ δίκτυο 3.500 επιχειρήσεων και σας προσφέρει καθημερινό όφελος σε πραγματικά ευρώ. Χρησιμοποιήστε κάρτες DreamBank σε όλες...</p>
				...
				<div class="portfolio-item">
                                    <a href="kartes.jsp"><h2>Kάρτες</h2></a><br>
